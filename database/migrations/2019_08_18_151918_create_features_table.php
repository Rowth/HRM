...
class CreateFeaturesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $data = [
            ...
            [
                'title' => 'Expense Claim',
                'description' => 'RowthTech makes it very easy to manage expenses made by employees and reimburse them. Be it online bill, mobile recharge, field expenses, etc. employees can add expenses they have made with all details including the bill. Approved expenses are automatically added to salary in payroll.',
                'image' => 'expense.png'
            ],
            [
                'title' => 'Leave Management',
                'description' => 'Applying for leaves is a cake walk with RowthTech. An Employee can apply for leaves on
            ...
            [
                ...
                'description' => 'RowthTech focuses on providing easy access to information. Admin dashboard has common stats to give a good overview of what\'s going on in the organization. Stats like total employees, total departments, awards, attendance, company expenses, current month birthdays, awards list, etc. are available at hand on the dashboard itself.',
                'image' => 'admin_dash.png'
            ],
            [
                'title' => 'Employee Management',
                'description' => 'You can easily manage all the employees in the organization and their data with RowthTech. Tasks like adding new employees, updating employee information, deleting any existing employee, and others can now be done without much hassle. You can also assign Credit Leaves (Annual Leaves) to an employee based on his experience and performance.',
                'image' => 'employee_admin.png'
            ],
            [
                'title' => 'Pay Slip Generator',
                'description' => 'Why to use a separate payroll software for generating pay slips when it can be done in RowthTech itself. RowthTech provides a simple interface to make generating pay slip both easy and fun. Now add hourly payments, allowances, and deductions, and generate, edit and email payslips to employees, all using RowthTech.',
                'image' => 'payroll.png'
            ],
            [
                'title' => 'Awards Management',
                'description' => 'Being a good HR Manager, you frequently give awards and appreciation to employees. But, as a number of employees increase, keeping the track of them becomes difficult. No worries, with RowthTech you can comfortably manage all the awards, achievements, and appreciations given in your organization.',
                'image' => 'awards.png'
            ],
            [
                'title' => 'Notice Board',
                'description' => 'With RowthTech\'s notice board feature, you can make company-wide announcements. Notices are visible on employee dashboard and employees are also notified by email.',
                'image' => 'notice.png'
            ],
            [
                'title' => 'Company Expense Management',
                'description' => 'Now keep track of all the company expenses conveniently. Any expense, from a small pencil to big purchases like laptops, bills, party expenditure, etc. can be added the to the expense management. HRRowthTechM shows monthly expense stats to help you know if you are overspending and take measures on time.',
...
You can also see the attendance of employees month wise.',
            ...
            [
                ...
                'description' => 'RowthTech provides many options to customize RowthTech according to your needs. You can change details like the logo, company address, contact number, email and currency to use on Settings Page.',
                'image' => 'settings.png'
            ],
            [
                'title' => 'Multiple Admins',
                'description' => 'RowthTech supports multiple admins. Add admins without any restrictions to minimize your headache. You just need to create a new admin and email them the details of the new account.',
                'image' => 'admins.png'
            ],
            [
                'title' => 'Multiple Themes',
                'description' => 'RowthTech has 11 front end themes. Choose a theme that everyone likes, or the one that blends well with your company logo.',
                'image' => 'themes.png'
            ],
        ];
