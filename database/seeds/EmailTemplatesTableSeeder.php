   ...
   You have been awarded with <strong>##AWARD##</strong>.
    ...
    <b> ##NAME## </b>
        ...
        $email->save();
            ...
            $email->email_id = 'DOCUMENT_VERIFY';
            $email->subject = 'Document Verification Request';
            $email->body = 'Hi!
    
        <b> ##NAME## </b>
            <br /><br/>
                Please Approved My Document.Click ##LINK## to Visit the dashboard
            <br /><br />
            ';
            $email->save();
    ...
    <br />
        ...
        $email->save(); 
                ...
                // <b> ##NAME## </b>
                // <br /><br/>
                //     Please verify my document.Click ##LINK## to Visit the dashboard
                // <br /><br />
                ...
                // $email->save();
                 ...
                 $email = new EmailTemplate();
                 $email->email_id = 'DOCUMENT_STATUS';
                 $email->subject = 'Document Status';
                 $email->body = 'Hi!
         
                 <b> ##NAME## </b>
                 <br /><br/>
                     Your document ##DOCNAME## is ##STATUS## .Click ##LINK## to Visit the dashboard
                 <br /><br />
