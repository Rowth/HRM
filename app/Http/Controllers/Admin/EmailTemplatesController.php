...
class EmailTemplatesController extends AdminBaseController
{
    ...
    public function edit($id)
    {
        ...
        $employee_add = ["##NAME##", "##COMPANY_NAME##", "##EMAIL##", "##PASSWORD##", "##FILENAME##"];
        ...
        $document_verify = ['##NAME##', '##LINK##'];
        $this->data['email']['DOCUMENT_VERIFY'] = implode(" | ", $document_verify);

        $document_status = ['##NAME##', '##LINK##', '##DOCNAME##', '##STATUS##'];
        $this->data['email']['DOCUMENT_STATUS'] = implode(" | ", $document_status);
