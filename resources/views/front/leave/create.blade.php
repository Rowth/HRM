...
<?php
 ...
 $session= $allSessions['company_id'];
//  dd($session);
?>
    ...
    <div class="portlet-body form">
        ...
        <div class="tab-v1 margin-bottom-40">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#button-1" data-toggle="tab"> {{ __('core.singleDateLeave') }}</a></li>
                <li class=""><a href="#button-2" data-toggle="tab"> {{ __('core.multipleDateleave') }}</a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane fade active in" id="button-1">
                    ...
                    {{-- <div id="alert"></div> --}}
                    <!------------------------------ BEGIN FORM ----------------------------------------->
                    {!! Form::open(['class' => 'sky-form', 'id' => 'single_leaves_form', 'method' => 'POST']) !!}
                        ...
                        <div class="col-md-3 form-group">
                            <div>
                                <label class="input">
                                    ...
                                    <input type="text" class="margin-bottom-10 from-control" name="date[0]"
                                        id="leave" placeholder="{{ trans('core.leaveDate') }}">
                                </label>
                            </div>
                        </div>
                        <div class="col-md-3 form-group">
                            <div>
                                ...
                                foreach($leave as $val){
                                    $arr[$val->leaveType]= $val->leaveType;
                                }
                               ?>
                                {!! Form::select('leaveType[0]', $arr, null, [
                                    'class' => ' form-control leaveType margin-bottom-10',
                                    'id' => 'leaveType[0]',
                                    'onchange' => 'halfDayToggle(0,this.value)',
                                ]) !!}
                            </div>
                        </div>
                        <div class="col-md-2">
                            {!! Form::checkbox('halfleaveType[0]', 'yes', null, [
                                'class' => 'form-control margin-bottom-10 margin-bottom-10',
                            ]) !!}
                            Half Day
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-offset-4 col-md-8">
                            <button type="submit" class="btn-u btn-u-sea"
                                onclick="submitLeaves('single_leaves');return false;"><i class="fa fa-check"></i>
                ...
                <div class="tab-pane fade" id="button-2">
                    ...
                    <!------------------------------ Mutiple BEGIN FORM ----------------------------------------->
                    {!! Form::open(['class' => 'form-horizontal sky-form', 'id' => 'date_range_form', 'method' => 'POST']) !!}
                    ...
                    <div class="form-group">
                        <label for="inputEmail1" class="col-lg-2 control-label">{{ trans('core.selectedDays') }}
                        </label>
...
<script>
    ...
    $('#plusButton').click(function() {
        ...
        $(' <div class="row" id="row' + $i + '"> ' +
            ...
            $i + ']" id="leave' + $i + '" placeholder="Leave Date"></label></div></div>' +
            '<div class="col-md-2">{!! Form::select('leaveType[]', $leaveTypes, null, [
                'class' => 'form-control margin-bottom-10 leaveType',
                'id' => 'leaveType',
                'onchange' => 'halfDayToggle(0,this.value)',
            ]) !!}</div>' +
            '<div class="col-md-2">{!! Form::checkbox('halfleaveType[]', 'yes', null, [
                'class' => 'form-control margin-bottom-10',
                'id' => 'halfLeaveType',
            ]) !!} Half Day</div>' +
            '<div class="col-md-5"><input class="form-control margin-bottom-10" name="reason[' + $i +
            ']" type="text" value="" placeholder="Reason"/></div></div>').insertBefore($insertBefore);
