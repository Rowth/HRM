...
@section('mainarea')
    <div class="page-head">
                        ...
                        @if($loggedAdmin->manager!=1)
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a class="btn green all-button " onclick="showAdd();">
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @forelse ($departments as $index=>$department)
                                    <tr id="row{{ $department->id }}">
                                        ...
                                        @if($loggedAdmin->manager!=1)
                                            <td class=" ">
                                                <a class="btn purple all-button  btn-sm margin-bottom-10" data-toggle="modal"
                                                   href="#edit_static"
                                                   onclick="showEdit({{$department->id}},'{{ addslashes($department->name) }}')"><i
                                                            class="fa fa-edit"></i> {{trans('core.btnViewEdit')}}</a>

                                                <a class="btn all-button  red btn-sm margin-bottom-10" style="width: 94px"
                                                   href="javascript:;"
        ...
        <div class="modal fade apply_modal in" id="showModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
