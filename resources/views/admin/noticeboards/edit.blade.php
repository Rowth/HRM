        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <input type="checkbox" onchange="ToggleEmailNotification('notice_notification');return false;" class="make-switch" name="notice_notification" @if($loggedAdmin->company->notice_notification==1)checked @endif data-on-color="success"
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">{{trans('core.department')}}: <span class="required">
                                * </span>
                        </label>
                        <div class="col-md-6">
                            <select class="select2me form-control" name="department_id" id="department_id">
                                <option value="0">All</option>
                                @foreach ($departmentName as $key => $department)
                                <option value="{{ $department->id }}" {{ ( $notice->department_id == $department->id) ? 'selected' : '' }}>
                                    {{  $department->name }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <button type="button" class="btn green" id="noticeUpdate" onclick="ajaxUpdateNotice({{$notice->id}})">
