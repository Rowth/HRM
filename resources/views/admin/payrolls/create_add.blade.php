            ...
            <div class="form-group">
                ...
                <div class="col-md-7 margin-bottom-10">
                    <input type="text" class="form-control only-num" id="basic" name="basic" placeholder="@lang("core.basicSalary") "
                           value="{{$basicSalary}}">
                    <input type="hidden" id="basic1" name="basic1" 
...
<div class="col-md-6">
    <div class="portlet light bordered">
        ...
        for($i = 0; $i <count($deduction) ;$i++) {  
            $value = ($basicSalary*$deductions_value[$i])/100;
               ?>
                ...
                <div class="col-md-3  margin-bottom-10">
                    <input type="text" class="deduction form-control" placeholder="@lang("core.value")" value="{{ $value }}" name="deduction[]">
                </div>
                <label class="control-label col-md-1">{{$loggedAdmin->company->currency}}</label>
                <?php if($i >=1) { ?>
                <div class="col-md-2">
