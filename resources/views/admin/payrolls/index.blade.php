...
@section('mainarea')
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row ">
                            <div class="col-md-3">
                                <a class="btn all-button green" onclick="loadView('{{ route('admin.payrolls.create') }}')">
                            ...
                            <div class="col-md-3">
                                <a href="" class="btn all-button blue-chambray"
    ...
    <div class="modal fade apply_modal in" id="reportModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
