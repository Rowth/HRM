            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="name" placeholder="@lang(" core.name")" value="{{ $admin->name }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="email" placeholder="@lang(" core.loginEmail")" value="{{ $admin->email}}">
                        </div>
                    </div>
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-4 col-md-9">
                            <button type="button" onclick="updateLogin();return false;" class="btn green"><i class="fa fa-check"></i> {{trans('core.btnUpdate')}}</button>
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-4 col-md-9">
                            <button type="button" onclick="updatePassword();return false;" class="btn green"><i class="fa fa-check"></i> {{trans('core.btnUpdate')}}</button>
