...
<div class="row">
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="company_name" placeholder="Website Title" value="{{old('company_name')}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control" name="address" placeholder="Company Address">{{old('address')}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="number" class="form-control" name="contact" value="{{old('contact')}}" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="after-add-more">
                        <div class="form-group" id="dynamicAddRemove">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="myInput1" onchange="myChangeFunction(this)" name="testemaill[]" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="dynamicAddRemove">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="testpassword[]">
                            </div>
                        </div>

                        <div class="form-group change" style="margin-top: -20px;">
                            <label for="">&nbsp;</label><br />
                            <button class="btn btn-success btn-sm add-more" type="button"><i class="fa fa-plus"></i>Add
                                More</button>
                        </div>
                    </div>
                    <input type="hidden" class="form-control" id="myInput2" name="email" value="">
                    <input type="hidden" class="form-control" name="password" value="TESTPWD">
                    ...
                    <div class="form-group" id="timezone_container">
                        <input type="hidden" name="timezoneIndex" id="timezoneIndex" value="">
                        <label class="col-md-2 control-label">@lang("core.timezone"): </label>
                        <div class="col-md-6">
                            <select class="select2me form-control select2-hidden-accessible" name="timezone" id="timezone" tabindex="-1" aria-hidden="true">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-9">
                            <button type="button" onclick="companyCreate();return false;" class="btn green">{{trans('core.btnSubmit')}}</button>
    ...
    <script>
        ...
        jQ(document).ready(function() {
            jQ("body").on("click", ".add-more", function() {
                // alert("hello");
                var html = jQ(".after-add-more").first().clone();

                jQ(html).find(".change").html(
                    "<label for=''>&nbsp;</label><br/><a class='btn btn-warning btn-sm remove'>- Remove</a>"
                );

                jQ(".after-add-more").last().after(html);

            });

            jQ("body").on("click", ".remove", function() {
                jQ(this).parents(".after-add-more").remove();
            });
        });
    </script>
