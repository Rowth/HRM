            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        {{--Deductions--}}
    <div class="col-lg-12">
    <?php $deduction = json_decode($company['deductions']);
            $deductions_value = json_decode($company->deductions_value) ; ?>
        <div class="portlet-title">
        
            <div class="caption font-dark">
            <label class="control-label col-md-2">@lang("core.deductions")</label>
            </div>
        </div>
</div>
<div class="col-lg-12">
        <div class="portlet-body" >
            <?php 
            if(isset($deduction) && count($deduction)>0){
            for($i = 0; $i <count($deduction) ;$i++) {  
               ?>
                <div class="form-group" <?php if($i >=1) { ?>id="deduction{{$i}}" <?php } ?>>
                <label class="control-label col-md-2"></label>

                <div class="col-md-4 margin-bottom-10">
                    <input type="text" class="form-control" placeholder="@lang("core.deduction") {{$i}}" value="{{ $deduction[$i] }}" name="deductionTitle[]">
                </div>
                <div class="col-md-3  margin-bottom-10">
                    <input type="text" class="deduction form-control" placeholder="@lang("core.value")" value="{{ $deductions_value[$i] }}" name="deduction[]">
                </div>
                <label class="control-label col-md-1">%</label>
                <?php if($i >=1) { ?>
                <div class="col-md-2">
                    <button type="button" onclick="$('#deduction<?php if($i >=1) { ?>{{$i}}<?php } ?>').remove();" class="btn red btn-sm delete">
