                            ...
                            <li class="menu-dropdown classic-menu-dropdown {{ isset($hrMenuActive) ? $hrMenuActive : '' }}">
                                ...
                                <ul class="dropdown-menu pull-left">
                                    ...
                                    {{-------------------------------------Banner-------------------------------}}
                                        <li class="nav-item">
                                            <a class="nav-link"
                                               href="javascript: loadView('{{route('admin.banner.index')}}')">
                                                <i class="fa fa-quote-left"></i>
                                                <span class="title">{{__('menu.banner')}}</span>
                                                <span class="selected "></span>
                                            </a>
...
<style>
    ...
    .hor-menu .navbar-nav .dropdown-menu {
    ...
    .hor-menu .navbar-nav .dropdown-menu li a {
        width: 100% !important;
