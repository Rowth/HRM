        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <a href="javascript:;" onclick="UpdateDetails('{!! $employee->id !!}','personal')" class="btn btn-sm btn-success ">
            ...
            <div class="portlet-body">
                ...
                <div class="form-body">
                    <div class="form-group ">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div class="fileinput-preview fileinput-exists thumbnail" id="result" style="max-width: 200px; max-height: 200px;"></div>
                                <div>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">{{trans('core.name')}} <span class="required">* </span></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">{{trans('core.father_name')}} <span class="required">* </span></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">{{trans('core.email')}}<span class="required">* </span></label>
    ...
    <div class="col-md-6 col-sm-6">
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="javascript:;" onclick="UpdateDetails('{{$employee->id}}','company');return false" class="btn btn-sm btn-success ">
            ...
            <div class="portlet-body">
                ...
                <div class="form-body">
                    <div class="form-group">
                        <label class="col-md-3 control-label">{{trans('core.employeeID')}}<span class="required">* </span></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">{{trans('core.department')}}<span class="required">* </span></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">{{trans('core.designation')}}<span class="required">* </span></label>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Team Leader</label>
                        <div class="col-md-9">
                            <select class="select2me form-control" name="teamlead" id="teamlead">
                                <option value="0" {{ ( $employee->teamlead ==0) ? 'selected' : '' }}>Employee</option>
                                <option value="1" {{ ( $employee->teamlead ==1) ? 'selected' : '' }}>Senior</option>
                                <option value="2" {{ ( $employee->teamlead ==2) ? 'selected' : '' }}>Trainee</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                <input type="text" class="form-control" name="joining_date" readonly value="@if(empty($employee->joining_date))00-00-0000 @else {{date('d-m-Y',strtotime($employee->joining_date))}} @endif">
                                <span class="input-group-btn">
                                    <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                </span>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="checkbox" value="active" onchange="remove_exit();" class="make-switch" name="status" @if($employee->status=='active')checked
        ...
        <div class="portlet light bordered ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="javascript:;" onclick="UpdateDetails('{{$employee->id}}','bank');return false" class="btn btn-sm btn-success ">
        ...
        <div class="col-md-12 col-sm-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <button onclick="UpdateDetails('{!! $employee->id !!}','documents')" class="btn btn-sm btn-success ">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{$documents['resume']}}" target="_blank" class="btn btn-sm purple">@lang("core.viewResume")</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/resume/1') }}" class="btn btn-sm green">{{$documents['resume1'] == 1? "Accepted":"Accept"}}</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/resume/2') }}" class="btn btn-sm red">Reject</a>
                                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{$documents['offerLetter']}} " target="_blank" class="btn btn-sm purple">@lang("core.viewOfferLetter")</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/offerLetter/1') }}" class="btn btn-sm green">{{$documents['offerLetter1'] == 1? "Accepted":"Accept"}}</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/offerLetter/2') }}" class="btn btn-sm red">Reject</a>
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{$documents['joiningLetter']}}" target="_blank" class="btn btn-sm purple">@lang("core.viewJoiningLetter")</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/joiningLetter/1') }}" class="btn btn-sm green">{{$documents['joiningLetter1'] == 1? "Accepted":"Accept"}}</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/joiningLetter/2') }}" class="btn btn-sm red">Reject</a>
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{$documents['contract']}}" target="_blank" class="btn btn-sm purple">@lang("core.viewContractOrAgreement")</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/contract/1') }}" class="btn btn-sm green">{{$documents['contract1'] == 1? "Accepted":"Accept"}}</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/contract/2') }}" class="btn btn-sm red">Reject</a>
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{$documents['IDProof']}}" target="_blank" class="btn btn-sm purple">@lang("core.viewIDProof")</a>


                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/IDProof/1') }}" class="btn btn-sm green">{{$documents['IDProof'] == 1? "Accepted":"Accept"}}</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/IDProof/2') }}" class="btn btn-sm red">Reject</a>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    @if(isset($documents['IDProof2']))
                                    <a href="{{$documents['IDProof2']}}" target="_blank" class="btn btn-sm purple">@lang("core.viewIDProof2")</a>


                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/IDProof2/1') }}" class="btn btn-sm green">{{$documents['IDProof2'] == 1? "Accepted":"Accept"}}</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/IDProof2/2') }}" class="btn btn-sm red">Reject</a>
                                    @endif
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-md-2">@lang("core.dmc")</label>
                                ...
                                <div class="col-md-3">
                                    @if(isset($documents['dmc']))
                                    <a href="{{$documents['dmc']}}" target="_blank" class="btn btn-sm purple">@lang("core.viewDmc")</a>


                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/dmc/1') }}" class="btn btn-sm green">{{$documents['dmc'] == 1? "Accepted":"Accept"}}</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/dmc/2') }}" class="btn btn-sm red">Reject</a>
                                    @endif
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-md-2">@lang("core.schoolCertificates")</label>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="input-group input-large">
                                            ...
                                            <span class="input-group-addon btn default btn-file">
                                                ...
                                                <span class="fileinput-exists">
                                                    {{trans('core.change')}} </span>
                                                <input type="file" name="SchoolCertificates">
                                            </span>
                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput">
                                                {{trans('core.remove')}} </a>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    @if(isset($documents['SchoolCertificates']))
                                    <a href="{{$documents['SchoolCertificates']}}" target="_blank" class="btn btn-sm purple">@lang("core.viewschoolCertificates")</a>


                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/SchoolCertificates/1') }}" class="btn btn-sm green">{{$documents['SchoolCertificates'] == 1? "Accepted":"Accept"}}</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/SchoolCertificates/2') }}" class="btn btn-sm red">Reject</a>
                                    @endif
                                </div>
                            </div>

                            <div class="form-group">
                                @if($employee->teamlead==2)
                                <label class="control-label col-md-2">@lang("core.trainingCertificate")</label>
                                <div class="col-md-5">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="input-group input-large">
                                            <div class="form-control uneditable-input" data-trigger="fileinput">
                                            ...
                                            <span class="input-group-addon btn default btn-file">
                                                ...
                                                <span class="fileinput-exists">
                                                    {{trans('core.change')}} </span>
                                                <input type="file" name="TrainingCertificate">
                                            </span>
                                            <a href="#" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput">
                                                {{trans('core.remove')}} </a>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    @if(isset($documents['TrainingCertificate']))
                                    <a href="{{$documents['TrainingCertificate']}}" target="_blank" class="btn btn-sm purple">@lang("core.viewtrainingCertificate")</a>


                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/TrainingCertificate/1') }}" class="btn btn-sm green">{{$documents['TrainingCertificate'] == 1? "Accepted":"Accept"}}</a>

                                    <a href="{{ url('admin/employees/updateDocment/'.$employee->id.'/TrainingCertificate/2') }}" class="btn btn-sm red">Reject</a>
                                    @endif
                                </div>
                                @endif
                            </div>
