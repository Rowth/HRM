        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="btn-group">
                                    ...
                                    <a href="javascript: ;" onclick="addEmployee()" class="btn all-button  green">
                    ...
                    <table class="table table-striped table-bordered table-hover responsive hidden" id="sample_employees">
                        <thead>
                            <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="javascript: ;" onclick="confirmAddEmployee()" class="btn all-button  green">
