                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="full_name"
                                            placeholder="{{ trans('core.name') }}" value="{{ old('full_name') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        {!! Form::select('gender', ['male' => __('core.male'), 'female' => __('core.female')], old('gender'), [
                                            'class' => 'form-control',
                                        ]) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control " name="mobile_number"
                                            placeholder="{{ trans('core.phone') }}" value="{{ old('mobile_number') }}"
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"> {{ trans('core.annualOrCredit') }}
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">{{ trans('core.bin') }}
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">{{ trans('core.tax_payer_id') }}
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="control-label col-md-2">{{ trans('core.contractOrAgreement') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-2">{{ trans('core.dmc') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-2">{{ trans('core.schoolCertificates') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-2">{{ trans('core.trainingCertificate') }}</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-offset-4 col-md-9">
                                                    <button type="button" onclick="addEmployee();return false;"
                                                        class=" btn green">
