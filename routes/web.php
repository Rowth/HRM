...
Route::group(["namespace" => 'Front', 'middleware' => 'auth.employees', 'prefix' => 'panel'], function () {
    ...
    Route::get('profile-emp', ['as' => 'front.profileEmp', 'uses' => 'DashboardController@profileEmp']);
    Route::post('profileemppost/{id}', ['as' => 'front.profileemppost', 'uses' => 'DashboardController@profilePostEmp']);
...
Route::group(["namespace" => 'Admin', 'middleware' => ['auth.admin', 'auth.screenlock', 'plan.null'], 'prefix' => 'admin'], function () {
    ...
    Route::get('employees/updateDocment/{id}/{type}/{status}', ['as' => 'admin.employees.updateDocuent', 'uses' => 'EmployeesController@updateDocuent']);
    ...
    Route::post('leave_change_status/{id}', ['as' => 'admin.leave.change_status', 'uses' => 'LeavetypesController@change_status']);
    ...
    //Upload banner
    Route::resource('banner', 'BannerController', ['except' => ['show'], 'as' => 'admin']);
...
Route::group(["namespace" => 'Admin', 'middleware' => ['auth.superadmin', 'auth.screenlock'], 'prefix' => 'super-admin'], function () {
    ...
    // return View::make('admin/dashboard/dashboard_new', $this->data);
    // Route::get('dashboard_new','SuperAdminDashboardController@dashboard_new');
...
Route::get('dashboard_new', ["as" => "newdashboard", "uses" => "Site\HomeController@dashboard_new"]);
